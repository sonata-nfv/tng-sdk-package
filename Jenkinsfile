    ...
    stages {
        ...
        stage('Promoting/deploying containers to integration env') {
            ...
            steps {
                ...
                dir(path: 'tng-devops') {
                    sh 'ansible-playbook roles/sp.yml -i environments -e "target=sta-sp-v4.0 component=packager"'
                    sh 'ansible-playbook roles/vnv.yml -i environments -e "target=sta-vnv-v4.0 component=packager"'
                }
            }
        }
